...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'row', hint_class: :field_with_hint, error_class: :error do |b|
    ...
    b.wrapper :label_wrapper, tag: :div, class: 'small-6 columns' do |ba|
      ba.use :label, class: 'right inline'
    end

    b.wrapper :right_input_wrapper, tag: :div, class: 'small-18 columns' do |ba|
      ba.use :input
  ...
  config.wrappers :foundation, tag: 'div', class: 'row', hint_class: :field_with_hint, error_class: :error do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :horizontal_radio_and_checkboxes, tag: 'div', class: 'row' do |b|
    ...
    b.wrapper :container_wrapper, tag: 'div', class: 'small-offset-6 small-18 columns' do |ba|
