...
L.Control.FuseSearch = L.Control.extend({
    ...
    createResultItem: function(props, container, popup) {
        ...
        if (true || undefined !== popup) {
            L.DomUtil.addClass(resultItem, 'clickable');
            resultItem.onclick = function() {
                
            console.log('bibik');
            // _this._map.flyTo(feature.layer.getLatLng());
            // zoom_to_marker(feature.layer, 16);
            // _this._map.panTo(feature.layer.getLatLng()).setZoom(16);
            _this._map.setView(
                [feature.layer.getLatLng().lat, feature.layer.getLatLng().lng],
                17
            );
            // return;
            console.log('aftermap');
              // _this._map.on('animationend', function(e) {
